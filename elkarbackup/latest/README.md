...
All the supported envars and default settings are listed in `default.env` file. You can overwrite them, preferentially using the `docker-compose.yml` environment section.
...
| name                        | default value     | description |
|-----------------------------|-------------------|-------------|
| SYMFONY__EB__SECRET  | fba546d6ab6abc4a01391d161772a14e093c7aa2 | salted md5 hash |
